...
public class tigeritpie {
    ...
    void show() {
        ...
        // Creating the data
        PieChart.Data slice4 = new PieChart.Data("Technical Skills", 35);
        PieChart.Data slice5 = new PieChart.Data("Education", 25);
        PieChart.Data slice3 = new PieChart.Data("Soft Skills", 20);
        PieChart.Data slice1 = new PieChart.Data("Learning Mindset", 10);
        PieChart.Data slice2 = new PieChart.Data("Adaptability", 10);

        pie.getData().addAll(slice1, slice2, slice3, slice4, slice5);

        // Calculate total value
        double total = 35 + 25 + 20 + 10 + 10;
        ...
        pie.setTitle("Entry-Level Job Criteria at TigerIT Ltd.");
    }
}
