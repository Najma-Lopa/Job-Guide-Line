...
public class cefalopie {
    ...
    void show() {
        ...
        PieChart.Data slice2 = new PieChart.Data("Education", 30);
        PieChart.Data slice3 = new PieChart.Data("Soft Skills", 20);
        PieChart.Data slice4 = new PieChart.Data("Learning Orientation", 10);
        PieChart.Data slice5 = new PieChart.Data("Experience", 5);

        pie.getData().addAll(slice1, slice2, slice3, slice4, slice5);

        // Calculate total value
        double total = 35 + 30 + 20 + 10 + 5;
        ...
        pie.setTitle("Entry-Level Job Criteria at Cefalo");
    }
}
